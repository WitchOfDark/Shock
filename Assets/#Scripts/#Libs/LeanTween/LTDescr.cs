...
public class LTDescr
{
	...
	#region Initialize and Internal Methods
	...
	public LTDescr setDirection(float direction)
	{
		...
		if (this.direction != direction)
		{
			...
			} else
			{
				if (this._optional.path != null)
				{
					this._optional.path = new LTBezierPath(Utility.reverseVec3Array(this._optional.path.pts));
				} else if (this._optional.spline != null)
				{
					this._optional.spline = new LTSpline(Utility.reverseVec3Array(this._optional.spline.pts));
				}
