...
namespace CMF
{
	...
	{
		public Transform cameraTransform; //Transform component of camera;
		public Transform cameraTargetTransform; //Transform component of camera target;

		Transform tr;

		public CastType castType; //Whether a raycast or spherecast is used to scan for obstacles;
		...
		public LayerMask layerMask = ~0; //Layermask used for raycasting;
		int ignoreRaycastLayer; //Layer number for 'Ignore Raycast' layer;
		public Collider[] ignoreList; //List of colliders to ignore when raycasting;
		int[] ignoreListLayers; //Array to store layers of colliders in ignore list;
