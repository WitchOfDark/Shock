...
namespace CMF
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (cameraInput == null) Debug.LogWarning("No camera input script has been attached to this gameobject", this.gameObject);
        ...
        protected virtual void HandleCameraRotation()
        {
            ...
            Vector2 _input = cameraInput.GetCameraInput();

            RotateCamera(_input.x, _input.y);
        }
