...
namespace CMF
{
    ...
    public class AnimationControl : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            Vector3 _velocity = controller.GetSavedVelocity();

            //Split up velocity;
            Vector3 _horizontalVelocity = VectorMath.RejectAonB(_velocity, tr.up);
            ...
            animator.SetFloat("VerticalSpeed", _verticalVelocity.magnitude * VectorMath.SignedMagProjectAonB(_verticalVelocity.normalized, tr.up));
        ...
        void OnLand(Vector3 _v)
        {
            ...
            if (VectorMath.SignedMagProjectAonB(_v, tr.up) > -landVelocityThreshold)
                return;
